...
export const INPUT_VARIANTS = Object.freeze({
  default:
    'bg-white border border-gray-300 text-[#1F2937] placeholder:text-gray-400',
  filled:
    'bg-[#F8FAF5] border border-transparent text-[#1F2937] placeholder:text-gray-400',
  outlined:
    'bg-transparent border-2 border-[#2E7D32]/40 text-[#1F2937] placeholder:text-gray-400',
  ghost:
    'bg-transparent border border-transparent text-[#1F2937] placeholder:text-gray-400',
  underlined:
    'bg-transparent border-0 border-b-2 border-gray-300 rounded-none text-[#1F2937] placeholder:text-gray-400',
});
/* ---------------------------------- */
/* Sizes */
/* ---------------------------------- */
...
/* ---------------------------------- */
/**
 * Central design tokens for all color-related values.
 * These are used throughout the component to ensure consistency.
