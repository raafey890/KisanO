 ...
 * TooltipLoader
 *
 * A skeleton loader for Tooltips. Renders placeholder content with
 * pulse or shimmer animations to indicate loading state.
 *
 * Single Responsibility: Render skeleton loading UI for tooltips.
 * Does not manage tooltip state, positioning, or triggers.
 *
 * @module components/ui/Tooltip/TooltipLoader
 */
...
/**
 * TooltipLoader – a skeleton loader for tooltips.
 *
 * @component
 * @example
 * <TooltipLoader size="md" variant="shimmer" rows={2} />
 */
const TooltipLoader = memo(
  forwardRef(function TooltipLoader(
    {
      ...
      className = '',
      role = 'status',
      'aria-label': ariaLabel = 'Loading tooltip content',
      ...rest
    },
    ref,
  ) {
    ...
    const rowsToRender = useMemo(
      ...
      [rows,  variant, isAnimated, skeletonHeight],
    );
...
TooltipLoader.displayName = 'TooltipLoader';
