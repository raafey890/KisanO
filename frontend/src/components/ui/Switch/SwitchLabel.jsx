 ...
 * SwitchLabel
 *
 * A label component for Switch fields. Renders label text with optional
 * required or optional indicators and accessibility support.
 *
 * Single Responsibility: Render a label for switch fields.
 * Does not manage switch state or input logic.
 *
 * @module components/ui/Switch/SwitchLabel
 */
...
/**
 * SwitchLabel – a label for switch fields.
 *
 * @component
 * @example
 * <SwitchLabel htmlFor="notifications" required>
 *   Enable notifications
 * </SwitchLabel>
 *
 * @example
 * <SwitchLabel size="lg" optional>
 *   Dark mode
 * </SwitchLabel>
 */
const SwitchLabel = memo(
  forwardRef(function SwitchLabel(
    {
      children,
      htmlFor,
      size = DEFAULT_SIZE,
    ...
    const labelClasses = useMemo(() => {
      const base = getSwitchLabelClasses({
        size,
        className,
        disabled,
      });
...
SwitchLabel.propTypes = {
  ...
  /** ID of the associated switch input. */
