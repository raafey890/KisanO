 ...
 * DropdownLoader
 *
 * A skeleton loader for Dropdown menus. Renders placeholder content with
 * pulse or shimmer animations to indicate loading state.
 *
 * Single Responsibility: Render skeleton loading UI for dropdowns.
 * Does not manage dropdown state, triggers, or menu rendering.
 *
 * @module components/ui/Dropdown/DropdownLoader
 */
...
/**
 * DropdownLoader – a skeleton loader for dropdowns.
 *
 * @component
 * @example
 * <DropdownLoader size="md" variant="shimmer" rows={3} />
 */
const DropdownLoader = memo(
  forwardRef(function DropdownLoader(
    {
      ...
      className = '',
      role = 'status',
      'aria-label': ariaLabel = 'Loading dropdown items',
      ...rest
    },
    ref,
  ) {
...
DropdownLoader.displayName = 'DropdownLoader';
