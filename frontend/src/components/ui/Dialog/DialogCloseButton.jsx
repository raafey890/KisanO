 ...
 * DialogCloseButton
 *
 * A dedicated close button for dialogs. Renders a circular button with
 * a close (X) icon by default. Designed to be placed in DialogHeader actions.
 *
 * Single Responsibility: Render a close button for dialogs.
 * Does not handle dialog logic or positioning.
 *
 * @module components/ui/Dialog/DialogCloseButton
 */
...
/**
 * DialogCloseButton – a dedicated close button for dialogs.
 *
 * @component
 * @example
 * <DialogCloseButton onClick={onClose} size="md" />
 *
 * @example
 * <DialogCloseButton
 *   onClick={onClose}
 ...
 * />
 */
const DialogCloseButton = memo(
  forwardRef(function DialogCloseButton(
    {
      onClick,
      icon,
    ...
    const buttonClasses = useMemo(() => {
      const base = getDialogCloseButtonClasses({
        size,
        className,
        disabled,
      });
