 ...
 * DialogLoader
 *
 * A skeleton loader for Dialogs. Renders placeholder content with
 * pulse or shimmer animations to indicate loading state.
 *
 * Single Responsibility: Render skeleton loading UI for dialogs.
 * Does not manage dialog state, visibility, or content.
 *
 * @module components/ui/Dialog/DialogLoader
 */
...
/**
 * DialogLoader – a skeleton loader for dialogs.
 *
 * @component
 * @example
 * <DialogLoader size="md" variant="shimmer" rows={4} />
 */
const DialogLoader = memo(
  forwardRef(function DialogLoader(
    {
      ...
      className = '',
      role = 'status',
      'aria-label': ariaLabel = 'Loading dialog content',
      ...rest
    },
    ref,
  ) {
...
DialogLoader.displayName = 'DialogLoader';
