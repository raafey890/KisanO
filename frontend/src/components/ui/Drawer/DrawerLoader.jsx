 ...
 * DrawerLoader
 *
 * A skeleton loader for Drawers. Renders placeholder content with
 * pulse or shimmer animations to indicate loading state.
 *
 * Single Responsibility: Render skeleton loading UI for drawers.
 * Does not manage drawer state, visibility, or content.
 *
 * @module components/ui/Drawer/DrawerLoader
 */
...
/**
 * DrawerLoader – a skeleton loader for drawers.
 *
 * @component
 * @example
 * <DrawerLoader size="md" variant="shimmer" rows={5} />
 */
const DrawerLoader = memo(
  forwardRef(function DrawerLoader(
    {
      ...
      className = '',
      role = 'status',
      'aria-label': ariaLabel = 'Loading drawer content',
      ...rest
    },
    ref,
  ) {
...
DrawerLoader.displayName = 'DrawerLoader';
